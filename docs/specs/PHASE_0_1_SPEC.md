...
- **Pre-compact user guide**: Add documentation: "Before running /compact, ask Claude to save important context. Or let the post-compact prompt handle it automatically."
