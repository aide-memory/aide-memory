...
| **Analytics** | Basic: memory count, last recalled, hook breakdown. Default telemetry ON (opt-out). Track: installs vs inits, memories stored/recalled, hook trigger source, tool used, retention. | FREE (basic) |
